...
def gameToday():
	jsonData_fanduel_epl = requests.get('https://sportsbook.fanduel.com/cache/psmg/UK/59790.3.json').json()
...
def fetch():
  try:
  	jsonData_fanduel_epl = requests.get('https://sportsbook.fanduel.com/cache/psmg/UK/59790.3.json').json() #gives the game id
  except:
...
def fetchName(): 
  url = 'https://projects.fivethirtyeight.com/soccer-predictions/eliteserien/'
  #print('hello')
